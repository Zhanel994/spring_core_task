...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private final AuthService authService; //to work with login and logout logic

    public JwtFilter(JwtService jwtService, UserService userService, AuthService authService) {
